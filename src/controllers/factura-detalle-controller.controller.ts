...
export class FacturaDetalleControllerController {
  constructor(
  ...
  async getView() {
    return await this.facturaDetalleRepository.dataSource.execute(
      `SELECT *
      FROM dbo.vTransaccionesClientes`,
    );
  }
}
